...
adb shell pm install-existing com.sec.android.app.clockpackage
#adb shell pm install-existing com.sec.android.daemonapp
adb shell settings put global window_animation_scale 0.90
adb shell settings put global transition_animation_scale 1.10
adb shell settings put global animator_duration_scale 1.75