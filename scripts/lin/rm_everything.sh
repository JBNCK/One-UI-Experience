...
adb shell pm uninstall --user 0 com.samsung.android.wifi.resources
...
adb shell pm uninstall --user 0 com.samsung.android.cmfa.AuthTouch
...
adb shell settings put global window_animation_scale 0.80
adb shell settings put global transition_animation_scale 0.90
