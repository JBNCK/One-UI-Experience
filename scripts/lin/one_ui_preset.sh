...
adb shell pm install-existing com.samsung.android.mdx.kit
adb shell pm install-existing com.samsung.android.aware.service
adb shell pm install-existing com.samsung.android.app.sharelive
adb shell pm install-existing com.samsung.android.allshare.service.mediashare
adb shell pm install-existing com.samsung.android.allshare.service.fileshare
